...
$taskName = "AD-user-generate-table-report-failed-logons"
$taskGetAdUsersGuid = ""
...
$dataSourceName = "AD-user-generate-table-report-failed-logons"
...
try {
    ...
    if([string]::IsNullOrEmpty($response.dataSourceGUID)) {
        ...
        $body = @{
            name = "$dataSourceName";
            type = "3";
            model = @(@{key = "badPwdCount"; type = 0}, @{key = "CanonicalName"; type = 0}, @{key = "Department"; type = 0}, @{key = "Displayname"; type = 0}, @{key = "Enabled"; type = 0}, @{key = "SamAccountName"; type = 0}, @{key = "Title"; type = 0}, @{key = "UserPrincipalName"; type = 0});
...
$formName = "AD - Report - Accounts with failed logons"
$formGuid = ""
...
try
{
        ...
        [
  {
    ...
    "body": "The following report will show local AD accounts that have more than 3 failed logons. Please wait while the data is loading...",
...
$delegatedFormName = "AD - Report - Accounts with failed logons"
$delegatedFormGuid = ""
...
$taskActionName = "AD-export-report-accounts-failed-logons"
$taskActionGuid = ""
